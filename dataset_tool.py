...
def open_cifar10_nolabel(tarball: str, *, max_images: Optional[int]):
    images = []
    #labels = []
...
def open_dataset(source, *, max_images: Optional[int]):
    if os.path.isdir(source):
        ...
        elif os.path.basename(source) == 'cifar-10-python_custom.tar.gz':
            return open_cifar10_nolabel(source, max_images=max_images)
